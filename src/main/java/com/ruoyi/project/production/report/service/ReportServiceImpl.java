...
public class ReportServiceImpl implements IReportService {
     ...
     */
    @Override
    public String lineReport(int lineId, String productCode, String startTime, String endTime,String devType) throws IOException, DocumentException {
        //表头参数定义
        ...
        String fileName = PdfUtil.pdfName();
     ...
     */
    @Override
    public String singleReport(int singleId, int userId, String productCode, String startTime, String endTime,String devType) throws IOException, DocumentException {
