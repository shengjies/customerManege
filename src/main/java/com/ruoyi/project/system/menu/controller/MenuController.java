...
public class MenuController extends BaseController
{
    ...
    @GetMapping("/list")
    @ResponseBody
    public List<Menu> list(Menu menu, HttpServletRequest request)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(Menu menu,HttpServletRequest request)
    {
        return toAjax(menuService.updateMenu(menu,request));
    }
    ...
    {
        List<Map<String, Object>> tree = menuService.roleMenuTreeData(role,request);
        return tree;
    }
