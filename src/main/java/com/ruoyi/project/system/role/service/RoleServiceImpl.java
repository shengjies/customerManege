...
public class RoleServiceImpl implements IRoleService {
    ...
    public List<Role> selectRoleList(Role role, HttpServletRequest request) {
     ...
     */
    @Override
    public List<Role> selectRolesByUserId(Long userId,HttpServletRequest request) {
        List<Role> userRoles = roleMapper.selectRolesByUserId(userId);
        List<Role> roles = selectRoleAll(request);
        for (Role role : roles) {
     ...
     */
    @Override
    public List<Role> selectRoleAll(HttpServletRequest request) {
        return selectRoleList(new Role(),request);
    }
